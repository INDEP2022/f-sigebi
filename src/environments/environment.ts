...
export const environment = {
  production: true,
  API_URL: 'http://sigebimstest.indep.gob.mx/', //'http://localhost:3000/api/v1/',
  API_URL2: 'http://sigebimstest.indep.gob.mx/',

  URL_PREFIX: 'api/v1/',
  API_REPORTS_BASE: 'http://reports-test.indep.gob.mx/jasperserver/',
  API_REPORTS:
    'http://reports-test.indep.gob.mx/jasperserver/rest_v2/reports/SIGEBI/Reportes/',
