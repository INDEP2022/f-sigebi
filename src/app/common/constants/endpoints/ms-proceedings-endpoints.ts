export enum ProceedingsEndpoints {
  ...
  SearchMcons = 'mconsmassive',
  SearchDcons = 'dconsmassive',
  detailProceeding = 'detail-proceedings-delivery-reception',
  pupArmaClave = 'aplication/pup-weapon-key',
  pupBuscaSlash = 'aplication/pup-search-slash',
  getCount = 'aplication/getCount',
  getProceedings = 'aplication/getProceedings',
