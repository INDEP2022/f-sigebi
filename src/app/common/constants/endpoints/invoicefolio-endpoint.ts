export enum InvoiceFolioEndPoint {
  BasePage = 'invoicefolio',
  Folio = 'eat-folios-invoices',
  FolioSeparte = 'eat-foliosseparated',
  GetAuxFolio = 'eat-folios-invoices/get-aux-folini',
