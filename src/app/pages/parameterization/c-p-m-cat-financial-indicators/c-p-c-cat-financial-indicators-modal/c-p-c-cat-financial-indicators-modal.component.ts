...
@Component({
  selector: 'app-c-p-c-cat-financial-indicators-modal',
  templateUrl: './c-p-c-cat-financial-indicators-modal.component.html',
  styleUrls: ['./c-p-c-cat-financial-indicators-modal.css'],
})
export class CPCCatFinancialIndicatorsModalComponent implements OnInit {
  value = '';
  keyboard: Keyboard;
