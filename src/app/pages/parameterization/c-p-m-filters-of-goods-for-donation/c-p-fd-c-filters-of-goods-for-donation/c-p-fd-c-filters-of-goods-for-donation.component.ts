...
@Component({
  selector: 'app-c-p-fd-c-filters-of-goods-for-donation',
  templateUrl: './c-p-fd-c-filters-of-goods-for-donation.component.html',
  styles: [],
})
export class CPFdCFiltersOfGoodsForDonationComponent
  extends BasePage
  implements OnInit
{
  columns: any[] = [];
