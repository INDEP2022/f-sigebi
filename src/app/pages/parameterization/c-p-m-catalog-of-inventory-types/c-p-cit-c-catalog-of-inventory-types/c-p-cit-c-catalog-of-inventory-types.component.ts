...
@Component({
  selector: 'app-c-p-cit-c-catalog-of-inventory-types',
  templateUrl: './c-p-cit-c-catalog-of-inventory-types.component.html',
  styles: [],
})
export class CPCitCCatalogOfInventoryTypesComponent
  extends BasePage
  implements OnInit
{
