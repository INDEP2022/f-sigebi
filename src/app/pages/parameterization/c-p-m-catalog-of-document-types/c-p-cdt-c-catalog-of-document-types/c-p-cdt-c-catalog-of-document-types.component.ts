...
@Component({
  selector: 'app-c-p-cdt-c-catalog-of-document-types',
  templateUrl: './c-p-cdt-c-catalog-of-document-types.component.html',
  styles: [],
})
export class CPCdtCCatalogOfDocumentTypesComponent
  extends BasePage
  implements OnInit
{
  columns: any[] = [];
