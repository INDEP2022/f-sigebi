...
@Component({
  selector: 'app-c-p-rc-c-rate-catalog',
  templateUrl: './c-p-rc-c-rate-catalog.component.html',
  styles: [],
})
export class CPRcCRateCatalogComponent extends BasePage implements OnInit {
  columns: any[] = [];
  totalItems: number = 0;
