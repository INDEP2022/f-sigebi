...
@Component({
  selector: 'app-c-p-wc-c-banks-catalog',
  templateUrl: './c-p-wc-c-banks-catalog.component.html',
  styles: [],
})
export class CPWcCBanksCatalogComponent extends BasePage implements OnInit {
