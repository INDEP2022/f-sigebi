...
@Component({
  selector: 'app-c-p-cc-cost-catalog',
  templateUrl: './c-p-cc-cost-catalog.component.html',
  styles: [],
})
export class CPCcCostCatalogComponent extends BasePage implements OnInit {
  columns: any[] = [];
  data: any[] = [
    {
