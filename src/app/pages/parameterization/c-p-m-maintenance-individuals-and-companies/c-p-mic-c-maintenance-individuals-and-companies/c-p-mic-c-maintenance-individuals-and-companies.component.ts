...
@Component({
  selector: 'app-c-p-mic-c-maintenance-individuals-and-companies',
  templateUrl:
    './c-p-mic-c-maintenance-individuals-and-companies.component.html',
  styles: [],
})
export class CPMicCMaintenanceIndividualsAndCompaniesComponent
  extends BasePage
  implements OnInit
{
