...
@Component({
  selector: 'app-c-p-c-maintenance-deleg-subdeleg-modal',
  templateUrl: './c-p-c-maintenance-deleg-subdeleg-modal.component.html',
  styles: [],
})
export class CPCMaintenanceDelegSubdelegModalComponent implements OnInit {
