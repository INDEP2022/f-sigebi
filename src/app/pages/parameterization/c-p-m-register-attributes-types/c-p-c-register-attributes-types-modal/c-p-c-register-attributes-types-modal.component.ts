...
@Component({
  selector: 'app-c-p-c-register-attributes-types-modal',
  templateUrl: './c-p-c-register-attributes-types-modal.component.html',
  styles: [],
})
export class CPCRegisterAttributesTypesModalComponent implements OnInit {
