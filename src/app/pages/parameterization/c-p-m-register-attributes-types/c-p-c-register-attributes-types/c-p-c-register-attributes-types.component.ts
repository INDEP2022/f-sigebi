...
@Component({
  selector: 'app-c-p-c-register-attributes-types',
  templateUrl: './c-p-c-register-attributes-types.component.html',
  styles: [],
})
export class CPCRegisterAttributesTypesComponent
  extends BasePage
  implements OnInit
{
  ...
  openModal(context?: Partial<CPCRegisterAttributesTypesModalComponent>) {
