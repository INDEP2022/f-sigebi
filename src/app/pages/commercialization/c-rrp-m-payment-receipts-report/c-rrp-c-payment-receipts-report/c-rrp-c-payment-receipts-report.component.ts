...
@Component({
  selector: 'app-c-rrp-c-payment-receipts-report',
  templateUrl: './c-rrp-c-payment-receipts-report.component.html',
  styles: [],
})
export class CRrpCPaymentReceiptsReportComponent
  extends BasePage
  implements OnInit
{
