...
@Component({
  selector: 'app-c-fp-c-penalty-billing-main',
  templateUrl: './c-fp-c-penalty-billing-main.component.html',
  styles: [],
})
export class CFpCPenaltyBillingMainComponent implements OnInit {
