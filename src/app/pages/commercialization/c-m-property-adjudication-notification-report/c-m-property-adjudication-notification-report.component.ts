...
@Component({
  selector: 'app-c-m-property-adjudication-notification-report',
  templateUrl: './c-m-property-adjudication-notification-report.component.html',
  styleUrls: ['c-m-property-adjudication-notification-report.component.scss'],
})
export class CMPropertyAdjudicationNotificationReportComponent
  implements OnInit
{
  form: FormGroup;
