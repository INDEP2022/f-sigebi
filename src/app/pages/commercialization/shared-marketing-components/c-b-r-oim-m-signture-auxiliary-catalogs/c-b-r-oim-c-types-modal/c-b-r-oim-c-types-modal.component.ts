...
@Component({
  selector: 'app-c-b-r-oim-c-types-modal',
  templateUrl: './c-b-r-oim-c-types-modal.component.html',
  styles: [],
})
export class CBROimCTypesModalComponent extends BasePage implements OnInit {
