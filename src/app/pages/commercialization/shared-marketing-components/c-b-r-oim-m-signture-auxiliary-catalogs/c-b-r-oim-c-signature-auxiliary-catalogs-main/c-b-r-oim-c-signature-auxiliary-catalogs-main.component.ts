...
} from './c-b-r-oim-c-signature-auxiliary-catalogs-columns';

@Component({
  selector: 'app-c-b-r-oim-c-signature-auxiliary-catalogs-main',
  templateUrl: './c-b-r-oim-c-signature-auxiliary-catalogs-main.component.html',
  styles: [],
})
export class CBROimCSignatureAuxiliaryCatalogsMainComponent
  extends BasePage
  implements OnInit
{
  ...
  openModalType(context?: Partial<CBROimCTypesModalComponent>) {
    const modalRef = this.modalService.show(CBROimCTypesModalComponent, {
