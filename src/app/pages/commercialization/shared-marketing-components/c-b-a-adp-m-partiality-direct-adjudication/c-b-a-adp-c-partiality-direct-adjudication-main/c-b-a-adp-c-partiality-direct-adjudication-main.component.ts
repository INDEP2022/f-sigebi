...
@Component({
  selector: 'app-c-b-a-adp-c-partiality-direct-adjudication-main',
  templateUrl:
    './c-b-a-adp-c-partiality-direct-adjudication-main.component.html',
  styles: [],
})
export class CBAAdpCPartialityDirectAdjudicationMainComponent
  extends BasePage
  implements OnInit
{
