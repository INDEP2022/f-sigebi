...
@Component({
  selector: 'app-electronic-signatures-main-firm-modal',
  templateUrl: './electronic-signatures-main-firm-modal.component.html',
  styles: [],
})
export class ElectronicSignatureFirmModalComponent
  extends BasePage
  implements OnInit
{
  fileForm: FormGroup;
