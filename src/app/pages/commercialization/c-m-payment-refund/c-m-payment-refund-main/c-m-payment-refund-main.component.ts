...
import { TableCheckboxComponent } from '../../c-m-lcs-massive-conversion/components/table-checkbox/table-checkbox.component';
...
@Component({
  selector: 'app-c-m-payment-refund-main',
  templateUrl: './c-m-payment-refund-main.component.html',
  styles: [],
  animations: [
    trigger('OnInOut', [
      transition(':enter', [
...
export class CMPaymentRefundMainComponent extends BasePage implements OnInit {
