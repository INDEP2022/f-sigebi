...
import { GOOD_DELIVERY_COLUMNS } from './c-c-good-delivery-columns';

@Component({
  selector: 'app-c-c-good-delivery-main',
  templateUrl: './c-c-good-delivery-main.component.html',
  styles: [],
})
export class CCGoodDeliveryMainComponent extends BasePage implements OnInit {
  selectedRows: any[] = [];
