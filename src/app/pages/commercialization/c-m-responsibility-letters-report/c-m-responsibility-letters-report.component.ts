...
@Component({
  selector: 'app-c-m-responsibility-letters-report',
  templateUrl: './c-m-responsibility-letters-report.component.html',
  styles: [],
})
export class CMResponsibilityLettersReportComponent implements OnInit {
  settings1 = {
    ...TABLE_SETTINGS,
    actions: false,
    columns: {
