...
@Component({
  selector: 'app-c-m-layouts-configuration',
  templateUrl: './c-m-layouts-configuration.component.html',
  styleUrls: ['c-m-layouts-configuration.component.scss'],
})
export class CMLayoutsConfigurationComponent implements OnInit {
  settings1 = {
    ...TABLE_SETTINGS,
    actions: false,
    columns: {
