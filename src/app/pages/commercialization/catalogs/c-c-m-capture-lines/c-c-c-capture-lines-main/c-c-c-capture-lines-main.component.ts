...
@Component({
  selector: 'app-c-c-c-capture-lines-main',
  templateUrl: './c-c-c-capture-lines-main.component.html',
  styles: [],
})
export class CCCCaptureLinesMainComponent extends BasePage implements OnInit {
  selectedEvent: any[] = [];
