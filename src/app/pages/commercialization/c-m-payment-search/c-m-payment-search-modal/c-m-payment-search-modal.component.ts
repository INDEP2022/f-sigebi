...
@Component({
  selector: 'app-c-m-payment-search-modal',
  templateUrl: './c-m-payment-search-modal.component.html',
  styles: [],
})
export class CMPaymentSearchModalComponent extends BasePage implements OnInit {
