...
@Component({
  selector: 'app-c-m-payment-search-list',
  templateUrl: './c-m-payment-search-list.component.html',
  styles: [],
})
export class CMPaymentSearchListComponent extends BasePage implements OnInit {
  ...
  openModal(context?: Partial<CMPaymentSearchModalComponent>) {
    const modalRef = this.modalService.show(CMPaymentSearchModalComponent, {
