...
@Component({
  selector: 'app-c-bm-f-fr-cr-c-rectification-fields',
  templateUrl: './c-bm-f-fr-cr-c-rectification-fields.component.html',
  styles: [
  ]
})
export class CBmFFrCrCRectificationFieldsComponent extends BasePage implements OnInit {
