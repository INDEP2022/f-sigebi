...
export class CBmFFmdvdbCBaseSalesPreInvoicingComponent extends BasePage implements OnInit {
  ...
  constructor(private fb:FormBuilder, private modalService: BsModalService, private sanitizer: DomSanitizer, private excelService: ExcelService,) {
    super();
    this.settings = {
      ...this.settings,
      actions: {
  ...
  private prepareForm(){
    this.form = this.fb.group({
      event: [null, [Validators.required, Validators.maxLength(10), Validators.minLength(1), Validators.pattern(NUMBERS_PATTERN)]],
      idAllotment: [null, [Validators.maxLength(10), Validators.minLength(1), Validators.pattern(NUMBERS_PATTERN)]],
    })
  }
