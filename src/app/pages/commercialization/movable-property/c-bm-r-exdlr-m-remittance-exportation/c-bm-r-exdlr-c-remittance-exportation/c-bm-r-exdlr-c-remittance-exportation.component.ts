...
@Component({
  selector: 'app-c-bm-r-exdlr-c-remittance-exportation',
  templateUrl: './c-bm-r-exdlr-c-remittance-exportation.component.html',
  styles: [
  ]
})
export class CBmRExdlrCRemittanceExportationComponent extends BasePage implements OnInit {
