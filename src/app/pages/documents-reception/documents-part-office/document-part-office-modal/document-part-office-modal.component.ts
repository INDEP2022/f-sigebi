...
export class DocumentPartOfficeModalComponent extends BasePage implements OnInit {
  title: string = 'Datos';
    ...
    this.alertQuestion(
      ...
      if (question.isConfirmed) {
        if (this.documentForm.valid) {
          ...
          this.documentForm.controls['affair'].setValue(this.documentForm.get('affair').value.toUpperCase());
          this.documentForm.controls['officeNumber'].setValue(this.documentForm.get('officeNumber').value.toUpperCase());
          this.documentForm.controls['status'].setValue(this.documentForm.get('status').value.toUpperCase());
          this.documentForm.controls['registerUser'].setValue(userId.toUpperCase());

          console.log(this.documentForm.value);
          const body = this.documentForm.value;

          this.procedureManagementService.update(this.datos.id, body).subscribe({
            next: (data: any) => {
              this.handleSuccess();
            },
            error: (error) => {
