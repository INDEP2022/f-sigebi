...
const routes: Routes = [
  ...
  },
  {
    ...
    data: { screen: 'FOFPRECEPDOCUM_OFC', title: 'Recepción de Documentos (Oficialia de Partes)' },
    children: [
      {
        path: '',
        loadChildren: async () =>
          (await import('./documents-part-office/documents-part-office.module')).DocumentsPartOfficeModule,
      },
    ],
  },
  {
