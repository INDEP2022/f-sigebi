...
export class ConversionActDetailComponent implements OnInit {
  ...
  //Geters del Encabezado
    ...
    get designated() { return this.form.get('designated'); }
    get holder() { return this.form.get('holder'); }
    get officeNumber() { return this.form.get('officeNumber'); }
    get dateOffice() { return this.form.get('dateOffice'); }

  //Geters del Antecedentes I 
    get officeEntity() { return this.form.get('officeEntity'); }
    get dateOfficeAntecedentsI() { return this.form.get('dateOfficeAntecedentsI'); }
    get subscribed() { return this.form.get('subscribed'); }
    get charge() { return this.form.get('charge'); }
    get dependence() { return this.form.get('dependence'); }
    get customsOffice() { return this.form.get('customsOffice'); }
    get container() { return this.form.get('container'); }
    get containerNumber() { return this.form.get('containerNumber'); }

  //Geters del Antecedentes II
    get office() { return this.form.get('office'); }
    get dateOfficeAntecedentsII() { return this.form.get('dateOfficeAntecedentsII'); }
    get subscribedII() { return this.form.get('subscribedII'); }
    get chargeII() { return this.form.get('chargeII'); }
    get property() { return this.form.get('property'); }

    //Geters del Antecedentes III
    get dateIII() { return this.form.get('dateIII'); }
    get subscribed_1_III() { return this.form.get('subscribed_1_III'); }
    get charge_1_III() { return this.form.get('charge_1_III'); }
    get assign_1() { return this.form.get('assign_1'); }
    get subscribed_2_III() { return this.form.get('subscribed_2_III'); }
    get charge_2_III() { return this.form.get('charge_2_III'); }
    get assign_2() { return this.form.get('assign_2'); }
    get winerySAE() { return this.form.get('winerySAE'); }
    get verificationOf() { return this.form.get('verificationOf'); }
    get consistsOf() { return this.form.get('consistsOf'); }
    get correspondingTo() { return this.form.get('correspondingTo'); }
    get descriptionIII() { return this.form.get('descriptionIII'); }
    get antStatus() { return this.form.get('antStatus'); }

    //Geters de Primera
    get authorizedBy() { return this.form.get('authorizedBy'); }
    get addressee() { return this.form.get('addressee'); }

    //Geters de Cierre de Acta
    get dateClosingAct() { return this.form.get('dateClosingAct'); }
    get timeClosingAct() { return this.form.get('timeClosingAct'); }
    get closingFoja() { return this.form.get('closingFoja'); }
