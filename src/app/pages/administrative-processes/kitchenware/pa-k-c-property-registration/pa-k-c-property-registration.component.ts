...
@Component({
  selector: 'app-pa-k-c-property-registration',
  templateUrl: './pa-k-c-property-registration.component.html',
  styles: [
  ]
})
export class PaKCPropertyRegistrationComponent extends BasePage implements OnInit {
    ...
    data: Example[] = [
     ...
     get numberFile() { return this.form.get('numberFile'); }
     get causePenal() { return this.form.get('causePenal')}
     get preliminaryInquiry() { return this.form.get('preliminaryInquiry'); }
  ...
  */
  ...
  uploadTableMenaje(event: any){
   this.menajes = [];
   event.data.menajes! ? this.menajes = [...event.data.menajes] : this.alert('info', 'Oops...', 'Este Bien no tiene Menajes Asociados');
  }
