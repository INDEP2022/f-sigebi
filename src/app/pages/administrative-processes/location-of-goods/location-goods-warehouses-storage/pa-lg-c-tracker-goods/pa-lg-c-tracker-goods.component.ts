...
export class PaLgCTrackerGoodsComponent implements OnInit {
     ...
     get targetIndicator() { return this.formCriteria.get('targetIndicator'); }
     get status() { return this.formCriteria.get('status'); } 
     get goods() { return this.formCriteria.get('goods'); } 
     get goodFatherMenssagge() { return this.formCriteria.get('goodFatherMenssagge'); } 
     get approisedValue() { return this.formCriteria.get('approisedValue'); } 
     get to() { return this.formCriteria.get('to'); } 
     get dateImg() { return this.formCriteria.get('dateImg'); } 
     get description() { return this.formCriteria.get('description'); } 
     get attributes() { return this.formCriteria.get('attributes'); } 
     get identifier() { return this.formCriteria.get('identifier'); } 
     get furnitureInv() { return this.formCriteria.get('furnitureInv'); } 
     get siabiInv() { return this.formCriteria.get('siabiInv'); } 
     get cisiInv() { return this.formCriteria.get('cisiInv'); } 
     get socialCabinet() { return this.formCriteria.get('socialCabinet'); } 
     
     //Reactive Forms
     formCriterionFiles : FormGroup;
     // Criterio por expediente, Notificación y Dictamen
     get dossier() { return this.formCriterionFiles.get('dossier'); } 
     get numberFlyer() { return this.formCriterionFiles.get('numberFlyer'); } 
     get typeFlyer() { return this.formCriterionFiles.get('typeFlyer'); } 
     get listFiles() { return this.formCriterionFiles.get('listFiles'); } 
     get nameGiven() { return this.formCriterionFiles.get('nameGiven'); } 
     get numberCourt() { return this.formCriterionFiles.get('numberCourt'); } 
     get dateOficExt() { return this.formCriterionFiles.get('dateOficExt'); } 
     get publicMinistry() { return this.formCriterionFiles.get('publicMinistry'); } 
     get oficExtNo() { return this.formCriterionFiles.get('oficExtNo'); } 
     get opinion() { return this.formCriterionFiles.get('opinion'); } 
     get expoTrans() { return this.formCriterionFiles.get('expoTrans'); } 
     get amparo() { return this.formCriterionFiles.get('amparo'); } 
     get touchesPenal() { return this.formCriterionFiles.get('touchesPenal'); } 
     get preliminaryInvestigation() { return this.formCriterionFiles.get('preliminaryInvestigation'); } 
     get penalCause() { return this.formCriterionFiles.get('penalCause'); } 
