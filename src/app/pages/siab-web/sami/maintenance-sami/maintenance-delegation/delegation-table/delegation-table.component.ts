...
export interface IDelegation {
  requestid: string;
  delegrequestid: string;
  descdelegrequest: string;
  deleghomeid: string;
  DESC_DELEG_DOMICILIO: string;
  delegfgrid: string;
  descdelegfgr: string;
}

@Component({
  selector: 'app-delegation-table',
  templateUrl: './delegation-table.component.html',
  styleUrls: ['./delegation-table.component.css'],
})
export class DelegationTableComponent extends BasePage implements OnInit {
