...
@Component({
  selector: 'app-sw-comer-c-report-oi',
  templateUrl: './sw-comer-c-report-oi.component.html',
  styles: [],
})
export class SwComerCReportOiComponent extends BasePage implements OnInit {
