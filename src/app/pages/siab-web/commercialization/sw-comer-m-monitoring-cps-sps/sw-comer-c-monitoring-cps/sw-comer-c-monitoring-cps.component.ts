...
@Component({
  selector: 'app-sw-comer-c-monitoring-cps',
  templateUrl: './sw-comer-c-monitoring-cps.component.html',
  styles: [],
})
export class SwComerCMonitoringCpsComponent extends BasePage implements OnInit {
