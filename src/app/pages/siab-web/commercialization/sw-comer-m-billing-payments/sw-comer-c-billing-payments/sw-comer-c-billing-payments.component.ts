...
@Component({
  selector: 'app-sw-comer-c-billing-payments',
  templateUrl: './sw-comer-c-billing-payments.component.html',
  styles: [],
})
export class SwComerCBillingPaymentsComponent
  extends BasePage
  implements OnInit
{
  ...
  openModal(context?: Partial<SwComerCBillingPaymentsModalComponent>) {
