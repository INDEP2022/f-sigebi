...
@Component({
  selector: 'app-sw-comer-c-winners-report',
  templateUrl: './sw-comer-c-winners-report.component.html',
  styles: [],
})
export class SwComerCWinnersReportComponent extends BasePage implements OnInit {
