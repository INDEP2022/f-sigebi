...
@Component({
  selector: 'app-fdp-rft-c-review-technical-sheets',
  templateUrl: './fdp-rft-c-review-technical-sheets.component.html',
  styles: [],
})
export class FdpRftCReviewTechnicalSheetsComponent
  extends BasePage
  implements OnInit
{
  form: FormGroup;
