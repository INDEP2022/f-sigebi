...
@Component({
  selector: 'app-fdp-accr-c-acts-circumstantiated-cancellation-theft',
  templateUrl:
    './fdp-accr-c-acts-circumstantiated-cancellation-theft.component.html',
  styles: [],
})
export class FdpAccrCActsCircumstantiatedCancellationTheftComponent
  extends BasePage
  implements OnInit
{
