...
@Component({
  selector: 'app-fdp-ft-c-technical-sheets',
  templateUrl: './fdp-ft-c-technical-sheets.component.html',
  styles: [],
})
export class FdpFtCTechnicalSheetsComponent extends BasePage implements OnInit {
  form: FormGroup;
  totalItems: number = 0;
