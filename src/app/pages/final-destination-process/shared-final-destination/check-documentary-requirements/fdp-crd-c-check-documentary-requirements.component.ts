...
@Component({
  selector: 'app-fdp-crd-c-check-documentary-requirements',
  templateUrl: './fdp-crd-c-check-documentary-requirements.component.html',
  styles: [],
})
export class FdpCrdCCheckDocumentaryRequirementsComponent
  extends BasePage
  implements OnInit
{
  @Input() title: string;
