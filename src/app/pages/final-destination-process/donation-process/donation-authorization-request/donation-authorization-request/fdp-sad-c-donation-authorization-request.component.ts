...
@Component({
  selector: 'app-fdp-sad-c-donation-authorization-request',
  templateUrl: './fdp-sad-c-donation-authorization-request.component.html',
  styles: [],
})
export class FdpSadCDonationAuthorizationRequestComponent
  extends BasePage
  implements OnInit
{
  form: FormGroup;
