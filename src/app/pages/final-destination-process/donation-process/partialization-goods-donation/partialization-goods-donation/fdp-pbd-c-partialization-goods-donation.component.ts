...
@Component({
  selector: 'app-fdp-pbd-c-partialization-goods-donation',
  templateUrl: './fdp-pbd-c-partialization-goods-donation.component.html',
  styles: [],
})
export class FdpPbdCPartializationGoodsDonationComponent
  extends BasePage
  implements OnInit
{
  form: FormGroup;
