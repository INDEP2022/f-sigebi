...
@Component({
  selector: 'app-fdp-ridd-c-registration-inventories-donation',
  templateUrl: './fdp-ridd-c-registration-inventories-donation.component.html',
  styles: [],
})
export class FdpRiddCRegistrationInventoriesDonationComponent
  extends BasePage
  implements OnInit
{
  form: FormGroup;
