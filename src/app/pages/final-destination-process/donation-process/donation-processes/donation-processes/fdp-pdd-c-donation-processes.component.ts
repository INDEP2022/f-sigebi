...
@Component({
  selector: 'app-fdp-pdd-c-donation-processes',
  templateUrl: './fdp-pdd-c-donation-processes.component.html',
  styles: [],
})
export class FdpPddCDonationProcessesComponent implements OnInit {
  imgs1 = [
    {
