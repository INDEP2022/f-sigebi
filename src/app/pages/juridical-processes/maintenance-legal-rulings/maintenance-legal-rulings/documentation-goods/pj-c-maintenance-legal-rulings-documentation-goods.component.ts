...
@Component({
  selector: 'app-pj-c-maintenance-legal-rulings-documentation-goods',
  templateUrl:
    './pj-c-maintenance-legal-rulings-documentation-goods.component.html',
})
export class PJMaintenanceLegalRulingDocumentationGoodsComponent
  extends BasePage
