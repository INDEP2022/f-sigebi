...
export const JURIDICAL_FILE_DATA_UPDATE_FORM = {
  ...
  affairKey: new FormControl<IAffair>(null, Validators.required),
  ...
  institutionNumber: new FormControl<IIssuingInstitution>(
    null,
    Validators.required
  ),
  ...
  dictumKey: new FormControl<IOpinion>(null),
