...
@Component({
  selector: 'app-pj-dj-c-juridical-ruling-g',
  templateUrl: './pj-dj-c-juridical-ruling-g.component.html',
  styleUrls: ['./pj-dj-c-juridical-ruling-g.component.scss'],
})
export class PJDJJuridicalRulingGComponent
  extends BasePage
