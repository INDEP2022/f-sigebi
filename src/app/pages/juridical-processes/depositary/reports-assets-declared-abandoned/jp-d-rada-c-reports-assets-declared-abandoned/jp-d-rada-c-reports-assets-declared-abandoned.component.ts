...
@Component({
  selector: 'app-jp-d-rada-c-reports-assets-declared-abandoned',
  templateUrl: './jp-d-rada-c-reports-assets-declared-abandoned.component.html',
  styles: [],
})
export class JpDRadaCReportsAssetsDeclaredAbandonedComponent
  extends BasePage
  implements OnInit
{
