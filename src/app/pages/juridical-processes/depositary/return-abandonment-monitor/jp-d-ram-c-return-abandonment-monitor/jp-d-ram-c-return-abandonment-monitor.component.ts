...
@Component({
  selector: 'app-jp-d-ram-c-return-abandonment-monitor',
  templateUrl: './jp-d-ram-c-return-abandonment-monitor.component.html',
  styles: [],
})
export class JpDRamCReturnAbandonmentMonitorComponent
  extends BasePage
  implements OnInit
{
  form: FormGroup;
