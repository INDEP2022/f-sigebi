...
@Component({
  selector: 'app-jp-d-ucm-c-notice-of-abandonment-by-return',
  templateUrl: './jp-d-ucm-c-notice-of-abandonment-by-return.component.html',
  styles: [],
})
export class JpDUcmCNoticeOfAbandonmentByReturnComponent
  extends BasePage
  implements OnInit
{
  data: any[];
