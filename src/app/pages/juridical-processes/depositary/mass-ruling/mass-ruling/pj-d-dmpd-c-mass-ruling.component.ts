...
@Component({
  selector: 'app-pj-d-dmpd-c-mass-ruling',
  templateUrl: './pj-d-dmpd-c-mass-ruling.component.html',
  styleUrls: ['./pj-d-dmpd-c-mass-ruling.component.scss'],
})
export class PJDDMPDMassRulingComponent
  extends BasePage
