...
@Component({
  selector: 'app-pj-d-ra-c-assignation-goods-protection',
  templateUrl: './pj-d-ra-c-assignation-goods-protection.component.html',
  styleUrls: ['./pj-d-ra-c-assignation-goods-protection.component.scss'],
})
export class PJDRAAssignationGoodsProtectionComponent
  extends BasePage
