...
@Component({
  selector: 'app-jp-d-loo-c-legal-opinions-office',
  templateUrl: './jp-d-loo-c-legal-opinions-office.component.html',
  styles: [],
})
export class JpDLooCLegalOpinionsOfficeComponent
  extends BasePage
  implements OnInit
{
  data: any[];
