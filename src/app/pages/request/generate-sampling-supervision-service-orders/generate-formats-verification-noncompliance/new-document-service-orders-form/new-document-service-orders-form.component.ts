...
@Component({
  ...
  templateUrl: './new-document-service-orders-form.component.html',
  styleUrls: ['./new-document-service-orders-form.component.scss'],
})
export class NewDocumentServiceOrdersFormComponent
  extends BasePage
