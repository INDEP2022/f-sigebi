...
@Component({
  ...
  templateUrl: './gre-c-validate-dictum.component.html',
  styleUrls: ['./gre-c-validate-dictum.component.scss'],
})
export class GreCValidateDictumComponent extends BasePage implements OnInit {
