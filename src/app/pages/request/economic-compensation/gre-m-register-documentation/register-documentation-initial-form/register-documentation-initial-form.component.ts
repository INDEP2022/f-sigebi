...
@Component({
  selector: 'app-register-documentation-initial-form',
  templateUrl: './register-documentation-initial-form.component.html',
  styles: [],
})
export class RegisterDocumentationInitialFormComponent
  extends BasePage
  implements OnInit
{
  fileTypes: any[] = [];
