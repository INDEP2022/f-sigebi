...
@Component({
  selector: 'app-gre-c-payment-order-main',
  templateUrl: './gre-c-payment-order-main.component.html',
  styles: [],
})
export class GreCPaymentOrderMainComponent extends BasePage implements OnInit {
