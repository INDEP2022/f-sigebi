...
@Component({
  selector: 'app-gre-c-register-appointment-main',
  templateUrl: './gre-c-register-appointment-main.component.html',
  styles: [],
})
export class GreCRegisterAppointmentMainComponent
  extends BasePage
  implements OnInit
{
