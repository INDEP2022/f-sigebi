...
export class PrintReportModalComponent extends BasePage implements OnInit {
  ...
  rowsSelected(event: any) {
    ...
    const obj: any = {
      ...
      receptionDate: '2023-06-09',
      nameOfOwner: 'John Doe',
      holderCharge: 'Manager',
      phoneOfOwner: '1234567890',
      emailOfOwner: 'johndoe@example.com',
      transferenceId: 'T123',
      stationId: 'S123',
      authorityId: 'A123',
      regionalDelegationId: 'R123',
      sender: 'Jane Smith',
      observations: 'Some observations',
      targetUser: 'Target user',
      urgentPriority: true,
      indicatedTaxpayer: 'Indicated taxpayer',
      transferenceFile: 'file.pdf',
      transferEntNotes: 'Transfer notes',
      idAddress: 'A123',
      originInfo: 'Origin info',
      circumstantialRecord: 'Circumstantial record',
      previousInquiry: 'Previous inquiry',
      lawsuit: 'Lawsuit',
      protectNumber: 'P123',
      tocaPenal: 'T123',
      paperNumber: 'P123',
      paperDate: '2023-06-10',
      indicated: 'Indicated',
      ...
      affair: 'Affair',
      satDeterminant: 'Sat determinant',
      satDirectory: 'Sat directory',
      satZoneCoordinator: 'Sat zone coordinator',
      userCreated: 'User created',
      creationDate: '2023-06-08',
      userModification: 'User modification',
      modificationDate: '2023-06-08',
      typeOfTransfer: 'Type of transfer',
      domainExtinction: 'Domain extinction',
      version: 'Version',
      targetUserType: 'Target user type',
      trialType: 'Trial type',
      typeRecord: 'Type record',
      requestStatus: 'Request status',
      fileLeagueType: 'File league type',
      fileLeagueDate: '2023-06-11',
      rejectionComment: 'Rejection comment',
      authorityOrdering: 'Authority ordering',
      instanceBpm: 'Instance BPM',
      trial: 'Trial',
      compensationType: 'Compensation type',
      stateRequestId: 'S123',
      searchSiab: 'Search SIAB',
      priorityDate: '2023-06-12',
      ofRejectionsNumber: 2,
      rulingDocumentId: 'R123',
      reportSheet: 'Report sheet',
      nameRecipientRuling: 'Recipient name',
      postRecipientRuling: 'Recipient post',
      paragraphOneRuling: 'Paragraph one',
      paragraphTwoRuling: 'Paragraph two',
      nameSignatoryRuling: this.valuesSign.name, //Info nueva que se inserta
      postSignatoryRuling: this.valuesSign.post,
      ccpRuling: 'CCP ruling',
      rulingCreatorName: 'Creator name',
      rulingSheetNumber: 'R123',
      registrationCoordinatorSae: 'Coordinator SAE',
      emailNotification: 'notification@example.com',
      keyStateOfRepublic: 'State of Republic',
      instanceBpel: 'Instance BPEL',
      verificationDateCump: '2023-06-13',
      recordTmpId: 'RT123',
      coordregsae_ktl: 'Coordregsae_ktl',
    };
    console.log(obj);
    //Enviar nueva información a Request
    this.requestService.update(idDoc, obj).subscribe({
