...
@NgModule({
  declarations: [AceptProgrammingFormComponent, ConfirmProgrammingComponent, ShowProgrammingComponent, ElectronicSignatureListComponent, UploadFilesFormComponent, ShowSignatureProgrammingComponent],
  imports: [
    CommonModule,
    SharedModule,
    TabsModule,
