...
@Component({
  selector: 'app-gd-asd-c-approve-return-request',
  templateUrl: './gd-asd-c-approve-return-request.component.html',
  styleUrls: ['./gd-asd-c-approve-return-request.component.scss'],
})
export class GDASDApproveReturnRequestComponent
  extends BasePage
