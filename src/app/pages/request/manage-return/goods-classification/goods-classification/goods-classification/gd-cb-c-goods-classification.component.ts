...
@Component({
  selector: 'app-gd-cb-c-goods-classification',
  templateUrl: './gd-cb-c-goods-classification.component.html',
  styleUrls: ['./gd-cb-c-goods-classification.component.scss'],
})
export class GDCBGoodsClassificationComponent
  extends BasePage
