...
@Component({
  selector: 'app-gd-rsd-c-register-document-return',
  templateUrl: './gd-rsd-c-register-document-return.component.html',
  styleUrls: ['./gd-rsd-c-register-document-return.component.scss'],
})
export class GDRSDRegisterDocumentReturnComponent
  extends BasePage
