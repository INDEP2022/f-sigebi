...
export class UsersComponent extends BasePage implements OnInit, OnDestroy {
  ...
  btnAltaUsuarios(formData: any) {
    console.log('btnAltaUsuarios');
  }
  btnCopiarFuncion() {
  ...
  btnDesbloqueoUsuario(formData: any) {
    console.log('btnDesbloqueoUsuario');
  }
  btnBajaUsuarios(formData: any) {
    console.log('btnBajaUsuarios');
  }
}
