...
export const FilterMatchTracker: any = {
  ...
  expedientNum: 'fileNumber',
  flyerNum: 'fileNumber',
  judgeNum: 'fileNumber',
  trasnferExp: null,
  flyerType: 'fileNumber',
  officeDate: 'fileNumber',
  protection: 'fileNumber',
  indicatedName: null,
  publicMin: 'fileNumber',
  criminalCase: 'fileNumber',
  extOfficeNum: null,
