...
@Component({
  selector: 'app-gp-i-account-status',
  templateUrl: './gp-i-account-status.component.html',
  styles: [],
})
export class GpIAccountStatusComponent extends BasePage implements OnInit {
