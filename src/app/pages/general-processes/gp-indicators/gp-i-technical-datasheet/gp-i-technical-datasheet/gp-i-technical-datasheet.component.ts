...
@Component({
  selector: 'app-gp-i-technical-datasheet',
  templateUrl: './gp-i-technical-datasheet.component.html',
  styles: [],
})
export class GpITechnicalDatasheetComponent extends BasePage implements OnInit {
