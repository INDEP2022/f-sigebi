        ...
        if (change.action === 'filter') {
          ...
          filters.map((filter: any) => {
            ...
            const search: any = {
              ...
              keyTypeDocument: () => (searchFilter = SearchFilter.EQ),
              keySeparator: () => (searchFilter = SearchFilter.EQ),
              numberProceedings: () => (searchFilter = SearchFilter.EQ),
              flyerNumber: () => (searchFilter = SearchFilter.EQ),
              descriptionDocument: () => (searchFilter = SearchFilter.ILIKE),
              natureDocument: () => (searchFilter = SearchFilter.EQ),
            };
