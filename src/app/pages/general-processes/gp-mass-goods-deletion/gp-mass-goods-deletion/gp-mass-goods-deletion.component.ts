...
@Component({
  selector: 'app-gp-mass-goods-deletion',
  templateUrl: './gp-mass-goods-deletion.component.html',
  styles: [],
})
export class GpMassGoodsDeletionComponent extends BasePage implements OnInit {
  form = this.fb.group({
