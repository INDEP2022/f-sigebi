...
export class GoodTransAvaService extends HttpService {
  ...
  getAll(params?: ListParams | string): Observable<IListResponse<IGoodsTransAva>> {
    return this.get<IListResponse<IGoodsTransAva>>(GoodEndpoints.GoodsTransAva, params);
  }
