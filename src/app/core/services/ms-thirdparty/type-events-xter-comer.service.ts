...
export class TypeEventXterComerService extends HttpService {
    ...
    getAll(params?: ListParams | string): Observable<IListResponse<ITypeEventXtercomer>> {
    return this.get<IListResponse<ITypeEventXtercomer>>(ThirdPartyEndpoints.TypeEventsXterComer, params);
    }
