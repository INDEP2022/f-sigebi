export interface IComerExpenseDTO {
  ...
  monthExpense?: any;
  vatWithheld: string | number;
  isrWithheld: string | number;
...
export interface IComerGastosDev {
  idConcept: number | string;
  descConcept: string;
  iva: number | string;
  no_factura_rec: string;
  fecha_factura_rec: Date;
  id_evento: number;
  id_lote: any;
  usuario_capturo: string;
  ...
  ur_coordregional: any;
  direccion: string;
  usu_captura_siab: string;
  tipo_pe: any;
  adj: any;
  indicador: number;
}

export interface IComerExpenseDTO2 {
  // expenseNumber: string;
  conceptNumber: string;
  comment: string;
  amount: string;
