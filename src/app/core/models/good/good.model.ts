...
export interface IGoodDomicilies {
  ...
  status?: string;
  noClassificationEstate?: string;
  unit?: string;
  propertyType?: string;
  mtsTerrain?: number | null;
  mtsConsTerrain?: number | null;
  publicWrite?: string;
  regPubProperty?: string;
  valorAvaluo?: number | null;
  dateAvaluo?: string;
  certLibAssessment?: string;
  dateCertLibAssessment?: string;
  assessment?: string;
  dateCertAssessment?: string;
  datePff?: string;
  gravFavorTrans?: string;
  gravFavorTerce?: string;
  embargo?: string;
  embFavorTrans?: string;
  embFavorTerce?: string;
  coProperty?: string;
  porcentageCopro?: string;
  forecastEco?: string;
  porcForecastEco?: string;
  decreeExproProc?: string;
  decreeExproSupe?: string;
  declareRemediation?: string;
  heritage?: string;
  assurance?: string;
  folioTitleProp?: string;
  measuresAdjoin?: string;
  vouchersWater?: string;
  carry?: string;
  physicalPossession?: string;
  closure?: string;
  familyPatrimony?: string;
  problemmatics?: string;
  ...
  cadastralQuantum?: string;
  leased?: string;
  judiControversy?: string;
  legalSituation?: string;
  satAddress?: string;
  satColony?: string;
  satCityPopulation?: string;
  sat_municipality_delegation?: string;
  sat_federative_entity?: string;
